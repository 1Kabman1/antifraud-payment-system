...
0  Создаем 2 мерный массив timeSeries  первый это временем эспирации длина expirationTime , второй это очередь  FIFO , его длина 
   это точность  подчета платежей в секундах timePeriod
0.1 Нужно обозначить что измерения  expirationTime принимаются  только в минутах , а точность  подчета платежей в секундах timePeriod в секундах
